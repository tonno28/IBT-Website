    ...
    <>
        ...
        <div className="container-max relative">
          <div className="max-w-3xl">
            <nav className="flex items-center gap-2 text-xs text-zinc-muted mb-6">
              ...
              <span>/</span>
              <span className="text-zinc-secondary">Baubegleitung</span>
            </nav>
      ...
      <section className="section-padding bg-bg-card border-y border-zinc-border">
        <div className="container-max max-w-4xl">
          <p className="section-label text-center">Was ist enthalten</p>
      ...
      <section className="section-padding bg-bg-primary">
        <div className="container-max max-w-3xl">
          <p className="section-label text-center">BEG-Förderung</p>
          ...
          <p className="text-sm text-zinc-muted text-center leading-relaxed">
