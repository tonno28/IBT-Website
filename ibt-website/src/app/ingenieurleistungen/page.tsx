          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {leistungen.map((l) => (
              <Link
                key={l.href}
                href={l.href}
                className="card-hover p-6 flex flex-col gap-4 group border-amber/10 hover:border-amber/30"
              >
                <div className="flex items-start justify-between gap-4">
                  <div className="w-12 h-12 rounded-xl bg-amber/15 text-amber flex items-center justify-center text-2xl">
                    {l.icon}
                  </div>
