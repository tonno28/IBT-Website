...
export default function BlogPage() {
  return (
    <>
      <section className="pt-32 pb-16 px-4 sm:px-6 lg:px-8 bg-bg-primary relative overflow-hidden">
        ...
        <div className="container-max relative">
          <div className="max-w-2xl">
            <p className="section-label">Blog & Ratgeber</p>
      ...
      <section className="section-padding bg-bg-primary pt-8">
        <div className="container-max max-w-4xl">
            ...
            {posts.map((post) => (
              ...
              >
                <div className="flex items-start justify-between gap-4 mb-3">
                  <span className="badge-teal">{post.category}</span>
                  <time className="text-xs text-zinc-hint font-mono">
          ...
          <div className="mt-12 text-center">
            <div className="card-base p-8">
              <h3 className="font-semibold text-zinc-primary mb-2">Mehr Beiträge in Kürze</h3>
