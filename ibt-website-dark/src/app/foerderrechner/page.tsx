      ...
      <section className="pt-32 pb-16 px-4 sm:px-6 lg:px-8 bg-void relative overflow-hidden">
        ...
        <div className="container-max relative">
          <div className="text-center max-w-2xl mx-auto">
            <p className="section-eyebrow">BEG 2025</p>
        ...
        <div className="container-max">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div className="lg:col-span-2">
              <div className="bg-surface border border-line-dim rounded-2xl p-6 sm:p-8">
                <Foerderrechner />
              </div>
            </div>
            ...
            <div className="space-y-5">
              <div className="card p-5">
                <h3 className="font-semibold text-ink-bright mb-3">Hinweis zur Genauigkeit</h3>
              ...
              <div className="card p-5">
                <h3 className="font-semibold text-ink-bright mb-3">BEG-Kurzübersicht</h3>
                <div className="space-y-3">
                  {[
                    ...
                    <div key={row.label} className="flex justify-between text-sm">
                      ...
                      <span className="font-mono text-warm font-semibold">{row.value}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="card p-5">
                <h3 className="font-semibold text-ink-bright mb-2">Nächster Schritt</h3>
                <p className="text-sm text-ink-muted mb-4">
                  Als akkreditierter Energieberater stelle ich alle Anträge für Sie —
                  vollständig und korrekt.
                </p>
                <Link href="/kontakt" className="btn-electric w-full justify-center text-sm">
