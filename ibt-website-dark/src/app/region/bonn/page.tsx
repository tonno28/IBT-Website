      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 bg-void relative overflow-hidden">
        ...
        <div className="container-max relative max-w-3xl">
          <div className="flex items-center gap-2 mb-4">
            ...
            <p className="section-eyebrow mb-0">Region Bonn</p>
          </div>
          ...
          <div className="flex flex-wrap gap-3">
            <Link href="/kontakt" className="btn-electric">Anfrage Bonn</Link>
        ...
        <div className="container-max max-w-3xl">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-8">
            {[
              ...
              <div key={a.area} className="card p-3 text-center text-xs text-ink-body">{a.area}</div>
            ))}
          </div>
        </div>
      </section>
