    ...
    <>
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 bg-void relative overflow-hidden">
        ...
        <div className="container-max relative max-w-3xl">
          <div className="flex items-center gap-2 mb-4">
            ...
            <p className="section-eyebrow mb-0">Region Köln</p>
          </div>
          ...
          <div className="flex flex-wrap gap-3">
            <Link href="/kontakt" className="btn-electric">Anfrage Köln</Link>
            <Link href="/foerderrechner" className="btn-outline">Förderrechner starten</Link>
          </div>
        </div>
      </section>
      ...
      <section className="section-pad bg-surface border-y border-line-dim">
        <div className="container-max">
          <p className="section-eyebrow text-center">Leistungen in Köln</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 max-w-4xl mx-auto">
            {[
              ...
              <Link key={item.href} href={item.href} className="card p-5 group">
                ...
                <h3 className="font-semibold text-ink-bright text-sm mb-1 group-hover:text-electric transition-colors">{item.title}</h3>
