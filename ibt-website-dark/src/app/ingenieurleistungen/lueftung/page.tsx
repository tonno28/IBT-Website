    ...
    <>
        ...
        <div className="container-max relative">
          <div className="max-w-3xl">
            <nav className="flex items-center gap-2 text-xs text-ink-muted mb-6">
              ...
              <span>/</span>
              <span className="text-ink-body">Lüftungskonzept</span>
            </nav>
            ...
            <h1 className="text-4xl sm:text-5xl font-bold text-ink-bright leading-tight mb-6">
              Lüftungskonzept<br />
              <span className="text-warm">nach DIN 1946-6</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-3">
              <Link href="/kontakt" className="btn-electric">Lüftungskonzept anfragen</Link>
              <span className="self-center text-xs text-ink-ghost font-mono">ab 180 € (EFH)</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section-pad bg-surface border-y border-line-dim">
        <div className="container-max max-w-3xl">
          <p className="section-eyebrow text-center text-warm">Wann Pflicht?</p>
