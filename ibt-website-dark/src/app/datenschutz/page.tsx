  ...
  return (
    <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
      <div className="container-max max-w-2xl">
        <h1 className="text-3xl font-bold text-ink-bright mb-10">Datenschutzerklärung</h1>

        <div className="space-y-8 text-sm text-ink-muted leading-relaxed">
          <div>
            <h2 className="text-base font-semibold text-ink-bright mb-3">1. Datenschutz auf einen Blick</h2>
            <h3 className="text-sm font-semibold text-ink-body mb-2">Allgemeine Hinweise</h3>
            <p>
          ...
          <div>
            <h2 className="text-base font-semibold text-ink-bright mb-3">2. Datenerfassung auf dieser Website</h2>
            <h3 className="text-sm font-semibold text-ink-body mb-2">Wer ist verantwortlich für die Datenerfassung auf dieser Website?</h3>
            <p className="mb-3">
              Die Datenverarbeitung auf dieser Website erfolgt durch den Websitebetreiber:
              Jonas Tonn, IBT Ingenieurbüro Tonn, Rheinbach. Kontakt: info@ibt-tonn.de
            </p>

            <h3 className="text-sm font-semibold text-ink-body mb-2">Wie erfassen wir Ihre Daten?</h3>
            <p className="mb-3">
            ...
            <h3 className="text-sm font-semibold text-ink-body mb-2">Wofür nutzen wir Ihre Daten?</h3>
            <p>
          ...
          <div>
            <h2 className="text-base font-semibold text-ink-bright mb-3">3. Hosting</h2>
            <p>
          ...
          <div>
            <h2 className="text-base font-semibold text-ink-bright mb-3">4. Kontaktformular</h2>
            <p>
          ...
          <div>
            <h2 className="text-base font-semibold text-ink-bright mb-3">5. Ihre Rechte</h2>
            <p className="mb-2">
            ...
            <ul className="space-y-1 ml-4">
              {[
                ...
                <li key={r} className="flex items-start gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-electric shrink-0 mt-1.5" />
                  {r}
                </li>
              ))}
            </ul>
          ...
          <div>
            <h2 className="text-base font-semibold text-ink-bright mb-3">6. Förderrechner</h2>
            <p>
